...
public class ReservaController {
    ...
    public ResponseEntity<ReservaResponseDTO> obtenerPorId(@Parameter(description = "ID de la reserva", required = true) @PathVariable Long id) {
    ...
    public ResponseEntity<List<ReservaResponseDTO>> obtenerPorUsuario(@Parameter(description = "ID del usuario", required = true) @PathVariable Long usuarioId) {
    ...
    @ApiResponse(responseCode = "200", description = "Lista de reservas obtenida exitosamente")
    public ResponseEntity<List<ReservaResponseDTO>> obtenerPorFuncion(@Parameter(description = "ID de la función", required = true) @PathVariable Long funcionId) {
    ...
    @ApiResponse(responseCode = "200", description = "Lista de reservas obtenida exitosamente")
    public ResponseEntity<List<ReservaResponseDTO>> obtenerPorEstado(@Parameter(description = "Estado de la reserva", required = true, example = "PENDIENTE") @PathVariable String estado) {
    ...
    public ResponseEntity<ReservaResponseDTO> cancelar(@Parameter(description = "ID de la reserva", required = true) @PathVariable Long id) {
    ...
    public ResponseEntity<ReservaResponseDTO> confirmar(@Parameter(description = "ID de la reserva", required = true) @PathVariable Long id) {
    ...
    public ResponseEntity<Void> eliminar(@Parameter(description = "ID de la reserva", required = true) @PathVariable Long id) {
